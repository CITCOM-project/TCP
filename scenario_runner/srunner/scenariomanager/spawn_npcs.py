...
def main():
    ...
    spawn_npcs(**vars(args))

def spawn_npcs(car_lights_on=False, filterv='vehicle.*', filterw='walker.pedestrian.*', host='127.0.0.1', hybrid=False, number_of_vehicles=10, number_of_walkers=50, port=2000, safe=False, seed=None, sync=False, tm_port=8000):
    vehicles_list = []
    walkers_list = []
    all_id = []
